...
// elements_merged.js — auto-generated by generate_merged_elements.js
var ELEMENTS = [
  {
    "name": "Hydrogen",
    "symbol": "H",
...
const CATEGORIES = [
  { id: 'alkali-metals', cls: 'alkali-metal', label: 'Alkali Metals' },
  { id: 'alkaline-earth-metals', cls: 'alkaline-earth-metal', label: 'Alkaline Earth Metals' },
  { id: 'lanthanoids', cls: 'lanthanoid', label: 'Lanthanoids' },
  { id: 'actinoids', cls: 'actinoid', label: 'Aktinoids' },
  { id: 'transition-metals', cls: 'transition-metal', label: 'Transition Metals' },
  { id: 'noble-metals', cls: 'noble-metal', label: 'Noble Metals' },
  { id: 'post-transition-metals', cls: 'post-transition-metal', label: 'Post-Transition Metals' },
  { id: 'metalloids', cls: 'metalloid', label: 'Metalloids' },
  { id: 'other-nonmetals', cls: 'other-nonmetal', label: 'Other Nonmetals' },
  { id: 'halogen', cls: 'halogen', label: 'Halogens' },
  { id: 'noble-gasses', cls: 'noble-gas', label: 'Noble Gasses' },
  { id: 'unknown', cls: 'unknown', label: 'Unknown' },
];

const ORBITAL_MARGINS = [10, 15.5, 21, 26.5, 32, 37.5, 43];
const ORBITAL_DURATIONS = [40, 34, 28, 22, 16, 10, 4];

export { ELEMENTS, CATEGORIES, ORBITAL_MARGINS, ORBITAL_DURATIONS };